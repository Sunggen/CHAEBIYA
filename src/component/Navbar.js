    ...
    <div>
      <Container>
        <div className="nav-area">
         <img width={1300} src="https://cafeptthumb-phinf.pstatic.net/MjAyNDA2MDZfNyAg/MDAxNzE3NjUyOTI2NjQw.5Z0LXjCm3e0lfsbiIwdrtdhXDVyNCnakUauboXgaKYcg.c3FT5pKQ-Ag-BsYWUx3rpxRuauVeufUiIIi4ZulQ770g.JPEG/%ED%83%80%EC%9D%B4%ED%8B%80.jpg"/> 
        </div>
        <div className="nav-area">
